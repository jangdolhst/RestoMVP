-- Migracion: crear pedidos publicos via RPC seguro
-- Fecha: 2026-05-26
-- Objetivo:
--   1) Clientes sin cuenta pueden ordenar.
--   2) La consola no puede fijar precios/totales ni insertar items directos.

DROP POLICY IF EXISTS "Clientes pueden insertar órdenes" ON public.orders;
DROP POLICY IF EXISTS "Clientes pueden insertar items" ON public.order_items;
DROP POLICY IF EXISTS "Clientes pueden insertar items iniciales" ON public.order_items;
